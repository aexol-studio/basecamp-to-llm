...
describe("StepsResource", () => {
  ...
  describe("create", () => {
    it("should create a step with required fields", async () => {
      ...
      expect(client.post).toHaveBeenCalledWith(
        "/buckets/1/card_tables/cards/2/steps.json",
        {
          title: "Test Step",
        },
      );
  ...
  describe("update", () => {
    it("should update a step", async () => {
      ...
      expect(client.put).toHaveBeenCalledWith(
        "/buckets/1/card_tables/steps/123.json",
        {
          title: "Updated Step",
        },
      );
  ...
  describe("complete", () => {
    it("should mark a step as completed", async () => {
      ...
      expect(client.put).toHaveBeenCalledWith(
        "/buckets/1/card_tables/steps/123/completions.json",
        {
          completion: "on",
        },
      );
  ...
  describe("reposition", () => {
    it("should reposition a step within its card", async () => {
      ...
      expect(client.post).toHaveBeenCalledWith(
        "/buckets/1/card_tables/cards/2/positions.json",
        {
          source_id: 123,
          position: 3,
        },
  ...
  describe("getStepsForCard", () => {
    it("should get steps for a specific card", async () => {
      ...
      expect(client.get).toHaveBeenCalledWith(
        "/buckets/1/card_tables/cards/2.json",
      );
